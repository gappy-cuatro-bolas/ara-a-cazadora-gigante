...
<head>
  ...
  <title>🕷 Araña Cazadora Gigante | El mundo de las Arañas</title> 
...
<body>
  ...
  <div class="main-container">
    <div class="info-section">
      ...
      <p>La araña cazadora gigante (<em>Heteropoda maxima</em>) es considerada la araña con mayor envergadura de patas del mundo, alcanzando hasta 30 cm de extremo a extremo de sus patas. Originaria de las selvas de Laos, esta impresionante araña es un ejemplo perfecto de gigantismo en arácnidos.</p>
      
      <p>Su cuerpo es de color marrón claro con manchas oscuras, lo que le proporciona un excelente camuflaje en los troncos de los árboles donde habita. A pesar de su tamaño intimidante, es completamente inofensiva para los humanos y prefiere huir antes que enfrentarse.</p>
      
      <h3 class="section-title" style="margin-top: 2rem;">Características clave</h3>
      <ul>
        <li>Tamaño: Cuerpo 4.6 cm, envergadura de patas hasta 30 cm</li>
        <li>Coloración: Marrón claro con manchas oscuras</li>
        <li>Hábitat: Cuevas y selvas de Laos</li>
        <li>Dieta: Insectos, pequeños reptiles y anfibios</li>
        <li>Comportamiento: Nocturna, rápida y ágil</li>
        <li>Esperanza de vida: 2-3 años</li>
      </ul>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="gallery">
        <div class="gallery-item">
          <img src="https://cloudfront-us-east-1.images.arcpublishing.com/infobae/HP6S6VSSLRF6TFMGDGM4VNV56I.webp" alt="Araña cazadora gigante en un tronco">
    ...
    <div class="info-section">
      ...
      <p>Esta especie es endémica de la provincia de Khammouan en Laos, donde habita principalmente en cuevas de piedra caliza y en los bosques circundantes. Su distribución es muy limitada, lo que la hace particularmente vulnerable a cambios en su hábitat.</p>
      
      <div class="map-container">
        <div id="distribution-map"></div>
        <div class="map-legend">
          <span class="legend-color"></span> Distribución en Laos
        </div>
      </div>
    </div>
    ...
    <div class="venom-section">
      ...
      <p>A pesar de su tamaño intimidante, el veneno de <em>Heteropoda maxima</em> no es peligroso para los humanos. Su mordedura puede causar dolor localizado y leve hinchazón, similar a una picadura de avispa. Su principal defensa es su velocidad y agilidad, siendo capaz de moverse extremadamente rápido.</p>
    ...
    <div class="info-section">
      ...
      <p>La araña cazadora gigante es nocturna y pasa el día escondida en grietas o bajo cortezas de árboles. A diferencia de muchas arañas, no construye telarañas para cazar, sino que acecha activamente a sus presas, usando su velocidad y agilidad para capturarlas.</p>
      
      <p>Son arañas solitarias que solo se juntan para aparearse. Las hembras pueden ser agresivas con los machos después del apareamiento, por lo que estos deben retirarse rápidamente para evitar ser devorados.</p>
    </div>
    ...
    <div class="info-section">
      ...
      <ul>
        ...
        <li>Sus patas están adaptadas para agarrarse a superficies irregulares</li>
        <li>No teje telarañas, es cazadora activa</li>
        <li>Su gran tamaño puede ser una adaptación a la vida en cuevas</li>
        <li>Posee visión nocturna excelente</li>
        <li>Considerada la araña con mayor envergadura de patas del mundo</li>
      </ul>
    </div>
  </div>
  ...
  <footer>
    ...
    <div class="footer-bottom">
      &copy; 2025 El mundo de las Arañas. Todos los derechos reservados. | Especial Arañas Cazadoras Gigantes
    </div>
  </footer>
  ...
  <script>
    ...
    // Mapa de distribución específica para Laos
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Área de distribución aproximada en Laos
      const laosCoords = [
      ...
      L.polygon([laosCoords], {
        ...
        fillOpacity: 0.2,
        weight: 1
      }).addTo(map).bindPopup('<b>Área de distribución</b><br>Heteropoda maxima');

      // Punto exacto donde se descubrió
      ...
      L.control({position: 'bottomleft'}).addTo(map).getContainer().innerHTML = 
        '<div style="background: rgba(0,0,0,0.7); padding: 5px; color: white; border-radius: 5px; font-size: 12px;">Distribución limitada a Laos</div>';
    });
  </script>
</body>
</html>
